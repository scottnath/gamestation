...
function gameKicker(gamefilename){
	exec('/opt/retropie/emulators/retroarch/bin/retroarch -L /opt/retropie/libretrocores/lr-imame4all/libretro.so /home/pi/RetroPie/roms/mame-mame4all/' + gamefilename + '.zip', function(error, stdout, stderr) {
	  if (!error) {
